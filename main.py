...
class RubiksCube2x2:
    ...
    def rotate_face(self, face):
        self.cube[face] = [
            self.cube[face][2], self.cube[face][0],
            self.cube[face][3], self.cube[face][1]
        ]

    def rotate_face_prime(self, face):
        self.cube[face] = [
            self.cube[face][1], self.cube[face][3],
            self.cube[face][0], self.cube[face][2]
        ]
    ...
    def rotate(self, face, neighbors):
        ...
        for i in range(3):
            for j, pos in enumerate(neighbors[i][1]):
                self.cube[neighbors[i][0]][pos] = self.cube[neighbors[i + 1][0]][neighbors[i + 1][1][j]]
    ...
    def rotate_U_prime(self):
        ...
        self.cube['F'][0], self.cube['F'][1], \
        self.cube['R'][0], self.cube['R'][1], \
        self.cube['B'][0], self.cube['B'][1], \
        self.cube['L'][0], self.cube['L'][1] = \
        self.cube['R'][0], self.cube['R'][1], \
        self.cube['B'][0], self.cube['B'][1], \
        self.cube['L'][0], self.cube['L'][1], \
        self.cube['F'][0], self.cube['F'][1]
    ...
    def rotate_D_prime(self):
        ...
        self.cube['F'][2], self.cube['F'][3], \
        self.cube['R'][2], self.cube['R'][3], \
        self.cube['B'][2], self.cube['B'][3], \
        self.cube['L'][2], self.cube['L'][3] = \
        self.cube['L'][2], self.cube['L'][3], \
        self.cube['F'][2], self.cube['F'][3], \
        self.cube['R'][2], self.cube['R'][3], \
        self.cube['B'][2], self.cube['B'][3]
    ...
    def rotate_F_prime(self):
        ...
        self.cube['U'][2], self.cube['U'][3], \
        self.cube['R'][0], self.cube['R'][2], \
        self.cube['D'][0], self.cube['D'][1], \
        self.cube['L'][1], self.cube['L'][3] = \
        self.cube['L'][3], self.cube['L'][1], \
        self.cube['U'][2], self.cube['U'][3], \
        self.cube['R'][0], self.cube['R'][2], \
        self.cube['D'][0], self.cube['D'][1]
    ...
    def rotate_B_prime(self):
        ...
        self.cube['U'][0], self.cube['U'][1], \
        self.cube['R'][1], self.cube['R'][3], \
        self.cube['D'][2], self.cube['D'][3], \
        self.cube['L'][0], self.cube['L'][2] = \
        self.cube['L'][0], self.cube['L'][2], \
        self.cube['U'][0], self.cube['U'][1], \
        self.cube['R'][1], self.cube['R'][3], \
        self.cube['D'][2], self.cube['D'][3]
    ...
    def rotate_R(self):
        self.rotate_face('R')
        self.cube['F'][1], self.cube['F'][3], \
        self.cube['U'][1], self.cube['U'][3], \
        self.cube['B'][0], self.cube['B'][2], \
        self.cube['D'][1], self.cube['D'][3] = \
        self.cube['D'][1], self.cube['D'][3], \
        self.cube['F'][1], self.cube['F'][3], \
        self.cube['U'][1], self.cube['U'][3], \
        self.cube['B'][1], self.cube['B'][3]
    ...
    def rotate_L_prime(self):
        ...
        self.cube['U'][0], self.cube['U'][2], \
        self.cube['B'][1], self.cube['B'][3], \
        self.cube['D'][0], self.cube['D'][2] = \
        self.cube['D'][0], self.cube['D'][2], \
        self.cube['F'][0], self.cube['F'][2], \
        self.cube['U'][0], self.cube['U'][2], \
        self.cube['B'][0], self.cube['B'][2]
